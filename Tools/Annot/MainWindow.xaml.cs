...
public partial class MainWindow : System.Windows.Window
{
    public MainWindow()
    {
        ...
        Directory.Exists(config["InputDirectory"]);
        ...
        var navigator = new DirectoryNavigator(config["InputDirectory"], config["OutputDirectory"]);
        ClassList.ItemsSource = File.ReadAllLines(config["ClassListFile"])
        ...
        FileList.SelectionChanged   += (s, e) =>
        {
            window.Dispose();
            window = new(
                navigator.Move(FileList.SelectedIndex).ImagePath,
                ClassList.SelectedIndex,
                standardLineWidth,
                emphasizedLineWidth,
                tolerance,
        ...
        KeyDown                     += (s, e) =>
        {
            ...
            {
                File.WriteAllText(navigator.Current.LabelPath, window.GetLabelData());
            }
